...
public:
    ...
    void departureDelays() {
        ifstream file("/Users/savaglisic/Desktop/cleanflights1.csv");
        string line;
        int row = 0;
        ...
        file.close();
        file.open("/Users/savaglisic/Desktop/cleanflights1.csv");
        while (getline(file, line)) {
            stringstream ss(line);
            string item;
            int col = 0;
...
int main(){
    ...
    if(datastruct == "List") {
        ...
        AdjList all, sum, per;
        ifstream myFile;
        myFile.open("/Users/savaglisic/Desktop/cleanflights1.csv");
        ...
        cancellation = to_string(per.getWeight1(beg, end)*100);
    ...
    if(datastruct == "List"){
        cout<< "It has a " << cancellation << "% chance of being cancelled altogether." << endl;
    }
    cout << "-----------------------------------------------------" << endl;
    if(datastruct == "Matrix"){
