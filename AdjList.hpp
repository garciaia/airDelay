...
class AdjList
{
   ...
   private:
    ...
    public:
      ...
      int getWeight1(string, string);
      int getWeight2(string, string);
      vector<string> getAdjacent(string); 
      void printGraph();
      void sumFlights(AdjList);
...
int AdjList::getWeight1(string from, string to)
{
...
int AdjList::getWeight2(string from, string to)
{
...
void AdjList::sumFlights(AdjList adj){ //create list 2 w/ flight sums
    AdjList temp;
